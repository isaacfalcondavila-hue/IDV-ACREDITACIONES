...
app.get('/api/admin/events/:id/security.xlsx',auth,(req,res)=>res.redirect(`/api/admin/events/${req.params.id}/security.csv`));
app.get('/api/admin/events/:id/attendance.xlsx',auth,(req,res)=>res.redirect(`/api/admin/events/${req.params.id}/attendance.csv`));
...
app.get('/health',(req,res)=>res.json({ok:true,version:'6.4.1'}));
app.listen(PORT,()=>console.log(`IDV Acreditaciones v6.4.1: http://localhost:${PORT}`));
