...
function detectCompetition(title='', explicit='auto'){
  ...
  if(['libertadores','copa_ecuador','other'].includes(selected)) return selected;
...
app.get('/health',(req,res)=>res.json({ok:true,version:'6.10.0'}));
app.listen(PORT,()=>console.log(`IDV Acreditaciones v6.10.0: http://localhost:${PORT}`));
